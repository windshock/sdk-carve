...
2. **Coocon SASAPI (= Coocon iSAS smart-scraping client)** — server **JavaScript** (Rhino/V8) scraping engine.
   ...
   sweep now puts **44 apps carrying the channel across multiple industries** — finance (banks/savings/brokers/
   ...
   verified — not a runtime contact) — see COOCON_FLEET_CANDIDATES.md. (Carrier-identity=44; exact-config deep-confirmed=6; live-E2E
